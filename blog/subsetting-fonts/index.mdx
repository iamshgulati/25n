...
image: "https://images.unsplash.com/photo-1497219055242-93359eeed651?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&h=675&q=80"
...
You can now load the woff2 font files using `@font-face`, or using `next/font/local` package as I have shared in [this post](/blog/var-fonts-nextjs).
